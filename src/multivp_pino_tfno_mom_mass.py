...
@hydra.main(version_base="1.3", config_path="conf", config_name="config_pino_tfno_mom_mass.yaml")
def main(cfg: DictConfig):
    ...
    for epoch in range(cfg.max_epochs):
        ...
        if epoch > 0 and epoch < cfg.epoch_threshold_upper and epoch % 25 == 0:
            attenuation_factor_mom = attenuation_factor_mom * 1.118 if (cfg.phy_att_mom_max > cfg.phy_wt_mom * attenuation_factor_mom) else attenuation_factor_mom
            attenuation_factor_mass = attenuation_factor_mass * 1.118 if (cfg.phy_att_mass_max > cfg.phy_wt_mass * attenuation_factor_mass) else attenuation_factor_mass
